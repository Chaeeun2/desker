...
const Section7 = () => {
  ...
  const getMobileTexts = () => [
    ...
    {
      p: "데스커는 일하는 공간도 숨 쉴 수 있어야 한다고<br/>생각했습니다. 식물로 채운 워크라운지는<br/>단순한 인테리어를 넘어, ​자연의 리듬을 닮은<br/>회복과 몰입의 환경이 되길 바랐습니다.<br/><br/>자연을 닮은 디자인을 통해, 몸과 마음이 환기되는<br/>새로운 워크스페이스를 경험할 수 있었습니다."
    },
    {
    ...
    {
      p1: `일하는 공간에서도<br/>웃음과 감정의 환기가 필요하다고 생각했습니다.<br/><br/>데스커는 다양한 브랜드, 아티스트와의 협업을 통해<br/>잠시 머무는 순간에도 여유와 웃음이<br/>함께하고자 했습니다.<br/><br/><span style="font-weight: 800; color: #336DFF;">데스커 × 김씨네 과일 POP-UP</span><br/>워케이션 가든에서 진행되었던 특별 POP-UP!<br/>흥이 넘치는 '김씨네 과일'과 협업해<br/>워케이션을 방문하신 분들께<br/>특별하고 즐거운 경험을 선사하고자 했습니다.`,
      images1: [
  ...
  const getDesktopTexts = () => [
    ...
    {
      p: "데스커는 일하는 공간도 숨 쉴 수 있어야 한다고 생각했습니다.<br/>식물로 채운 워크라운지는 단순한 인테리어를 넘어,<br/>​자연의 리듬을 닮은 회복과 몰입의 환경이 되길 바랐습니다.<br/><br/>자연을 닮은 디자인을 통해,<br/>몸과 마음이 환기되는 새로운 워크스페이스를 경험할 수 있었습니다."
    },
    {

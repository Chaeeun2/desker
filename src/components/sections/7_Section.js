...
const Section7 = () => {
  ...
  const getMobileTexts = () => [
    ...
    {
      p1: `일하는 공간에서도<br/>웃음과 감정의 환기가 필요하다고 생각했습니다.<br/><br/>데스커는 다양한 브랜드, 아티스트와의 협업을 통해<br/>잠시 머무는 순간에도 여유와 웃음이 함께하고자 했습니다.<br/><br/><span style="font-weight: 800; color: #336DFF;">데스커 × 김씨네 과일 POP-UP</span><br/>워케이션 가든에서 진행되었던 특별 POP-UP!<br/>흥이 넘치는 '김씨네 과일'과 협업해 워케이션을 방문하신 분들께<br/>특별하고 즐거운 경험을 선사하고자 했습니다.`,
      images1: [

          ...
          <div className={styles.rightSide}>
            <div className={styles.contentWrapper}>
              <div ref={text1Ref} className={`${styles.description} ${text1HasIntersected ? styles.fadeIn : ''}`}>
                <p>바다 위에서 파도를 기다리는 시간은​<br/>일에서 벗어나는 것이 아니라,​<br/>다시 몰입을 위한 리듬을 찾는 순간이었습니다.<br/><br/>오전에는 업무에 집중하고,<br/>오후에는 바다에서 서핑을 즐기며​<br/>몰입과 이완이 자연스럽게 오가는 흐름 속에서​<br/>몸과 마음의 환기하는 시간을 경험할 수 있었습니다.</p>
              </div>
          ...
          <div className={styles.rightSide}>
            <div className={styles.contentWrapper}>
              <div ref={text2Ref} className={`${styles.description} ${text2HasIntersected ? styles.fadeIn : ''}`}>
                <p>데스커는 일하는 공간도 숨 쉴 수 있어야 한다고 생각했습니다.<br/>식물로 채운 워크라운지는 단순한 인테리어를 넘어,<br/>자연의 리듬을 닮은 회복과 몰입의 환경이 되길 바랐습니다.<br/><br/>자연을 닮은 디자인을 통해,<br/>​몸과 마음이 환기되는 새로운 워크스페이스를 경험할 수 있었습니다.</p>
              </div>
          ...
          <div className={styles.rightSide}>
            <div className={styles.contentWrapper}>
              <div ref={text3Ref} className={`${styles.description} ${text3HasIntersected ? styles.fadeIn : ''}`}>
                <p>야근과 격무속에서도 미래를 만들어가는 스타트업에게<br/>​쉼은 보상이자, 다시 나아가기 위한 숨고르기라 생각했습니다.​​<br/><br/>데스커는 디캠프와 함께 바다 위에서 D.DAY를 열고,<br/>​일과 쉼이 공존하는 스타트업의 새로운 문화를 만들어갔습니다.</p>
              </div>
          ...
          <div className={styles.rightSide}>
            <div className={styles.scrollableContent}>
              ...
              <div ref={text4Ref} className={`${styles.description} ${text4HasIntersected ? styles.fadeIn : ''}`}>
                <p>일하는 공간에서도<br/>​웃음과 감정의 환기가 필요하다고 생각했습니다.​<br/><br/>데스커는 다양한 브랜드, 아티스트와의 협업을 통해​<br/>잠시 머무는 순간에도 여유와 웃음이 함께하고자 했습니다.​<br/><br/><br/><span style={{fontWeight: '800'}}>데스커 × 김씨네 과일 POP-UP</span><br/>워케이션 가든에서 진행되었던 특별 POP-UP!<br/>흥이 넘치는 '김씨네 과일'과 협업해 워케이션을 방문하신 분들께<br/>특별하고 즐거운 경험을 선사하고자 했습니다.</p>
              </div>
              ...
              {/* 두 번째 텍스트 */}
              <div ref={text4SecondRef} className={`${styles.description} ${text4SecondHasIntersected ? styles.fadeIn : ''}`} style={{marginTop: '100px'}}>
                <p><span style={{fontWeight: '800'}}>데스커 × 순이지</span><br/>순이지 작가의 아트웍으로 완성된 일러스트와 함께<br/>새로워진 워케이션 공간을 선보였습니다.</p>
              </div>
